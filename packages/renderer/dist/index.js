...
import_isomorphic_dompurify.default.addHook("uponSanitizeAttribute", (_node, data) => {
...
import_isomorphic_dompurify.default.addHook("uponSanitizeAttribute", (node, data) => {
